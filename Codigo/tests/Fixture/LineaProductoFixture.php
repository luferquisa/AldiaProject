...
/**
 * LineaProductoFixture
 *
 */
class LineaProductoFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'linea_producto_recurso_fkey' => ['type' => 'foreign', 'columns' => ['recurso'], 'references' => ['recursos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
